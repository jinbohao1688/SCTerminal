...
build_time_vars = {
    ...
    'AR': '/home/wyqsxsxz/ohos-sdk/sdk/default/openharmony/native/llvm/bin/llvm-ar',
    'ARFLAGS': 'rcs',
    'BASECFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code',
    'BASECPPFLAGS': '-IObjects -IInclude -IPython',
    'BASEMODLIBS': '',
    'BINDIR': '/data/app/base.org/base_1.0/bin',
    'BINLIBDEST': '/data/app/base.org/base_1.0/lib/python3.13',
    'BLDLIBRARY': '-L. -lpython3.13',
    'BLDSHARED': '/home/wyqsxsxz/ohos-sdk/sdk/default/openharmony/native/llvm/bin/x86_64-unknown-linux-ohos-clang -shared -L/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/lib -L/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/lib',
    'BOOTSTRAP_HEADERS': '\\',
    'BUILDEXE': '',
    'BUILDPYTHON': 'python',
    ...
    'BYTESTR_DEPS': '\\',
    'CC': '/home/wyqsxsxz/ohos-sdk/sdk/default/openharmony/native/llvm/bin/x86_64-unknown-linux-ohos-clang',
    'CCSHARED': '-fPIC',
    'CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -I/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/include -Wno-int-conversion -O2 -I/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/include/ncursesw -I/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/include -Wno-int-conversion -O2 -I/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/include/ncursesw',
    ...
    'CONFIGURE_CFLAGS': '-I/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/include -Wno-int-conversion -O2 -I/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/include/ncursesw',
    ...
    'CONFIGURE_CPPFLAGS': '',
    'CONFIGURE_LDFLAGS': '-L/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/lib',
    'CONFIGURE_LDFLAGS_NODIST': '',
    'CONFIGURE_LDFLAGS_NOLTO': '',
    'CONFIG_ARGS': "'ANDROID_API_LEVEL=1' '--prefix=/data/app/base.org/base_1.0' '--disable-test-modules' '--enable-shared' '--host' 'x86_64-unknown-linux-musl' '--build=x86_64' '--enable-ipv6' '--with-ensurepip=install' '--with-build-python=/home/wyqsxsxz/Termony/build-hnp/python/temp/native/usr/local/bin/python3' 'ac_cv_file__dev_ptmx=no' 'ac_cv_file__dev_ptc=no' 'build_alias=x86_64' 'host_alias=x86_64-unknown-linux-musl' 'PKG_CONFIG_LIBDIR=/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/lib/pkgconfig:/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/share/pkgconfig' 'CC=/home/wyqsxsxz/ohos-sdk/sdk/default/openharmony/native/llvm/bin/x86_64-unknown-linux-ohos-clang' 'CFLAGS=-I/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/include -Wno-int-conversion -O2 -I/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/include/ncursesw' 'LDFLAGS=-L/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/lib'",
    'CONFINCLUDEDIR': '/data/app/base.org/base_1.0/include',
    'CONFINCLUDEPY': '/data/app/base.org/base_1.0/include/python3.13',
    'COREPYTHONPATH': '',
    'COVERAGE_INFO': '/home/wyqsxsxz/Termony/build-hnp/python/temp/Python-3.13.5/build/coverage.info',
    'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
    'COVERAGE_REPORT': '/home/wyqsxsxz/Termony/build-hnp/python/temp/Python-3.13.5/build/lcov-report',
    ...
    'CXX': '/home/wyqsxsxz/ohos-sdk/sdk/default/openharmony/native/llvm/bin/x86_64-unknown-linux-ohos-clang++',
    'DESTDIRS': '/data/app/base.org/base_1.0 /data/app/base.org/base_1.0/lib /data/app/base.org/base_1.0/lib/python3.13 /data/app/base.org/base_1.0/lib/python3.13/lib-dynload',
    'DESTLIB': '/data/app/base.org/base_1.0/lib/python3.13',
    'DESTPATH': '',
    'DESTSHARED': '/data/app/base.org/base_1.0/lib/python3.13/lib-dynload',
    'DFLAGS': '',
    'DIRMODE': 755,
    ...
    'EXE': '',
    'EXEMODE': 755,
    'EXENAME': '/data/app/base.org/base_1.0/bin/python3.13',
    'EXPORTSFROM': '',
    'EXPORTSYMS': '',
    'EXTRATESTOPTS': '',
    'EXTRA_CFLAGS': '',
    ...
    'FILEMODE': 644,
    'FREEZE_MODULE': '/home/wyqsxsxz/Termony/build-hnp/python/temp/native/usr/local/bin/python3 ../Programs/_freeze_module.py',
    'FREEZE_MODULE_BOOTSTRAP': '/home/wyqsxsxz/Termony/build-hnp/python/temp/native/usr/local/bin/python3 ../Programs/_freeze_module.py',
    ...
    'INCLDIRSTOMAKE': '/data/app/base.org/base_1.0/include /data/app/base.org/base_1.0/include /data/app/base.org/base_1.0/include/python3.13 /data/app/base.org/base_1.0/include/python3.13',
    'INCLUDEDIR': '/data/app/base.org/base_1.0/include',
    'INCLUDEPY': '/data/app/base.org/base_1.0/include/python3.13',
    ...
    'JIT_DEPS': '\\',
    'LDCXXSHARED': '/home/wyqsxsxz/ohos-sdk/sdk/default/openharmony/native/llvm/bin/x86_64-unknown-linux-ohos-clang++ -shared -L/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/lib -L/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/lib',
    'LDFLAGS': '-L/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/lib -L/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/lib',
    'LDFLAGS_NODIST': '',
    'LDLIBRARY': 'libpython3.13.so',
    'LDLIBRARYDIR': '',
    'LDSHARED': '/home/wyqsxsxz/ohos-sdk/sdk/default/openharmony/native/llvm/bin/x86_64-unknown-linux-ohos-clang -shared -L/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/lib -L/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/lib',
    'LDVERSION': '3.13',
    'LIBC': '',
    'LIBDEST': '/data/app/base.org/base_1.0/lib/python3.13',
    'LIBDIR': '/data/app/base.org/base_1.0/lib',
    'LIBEXPAT_A': 'Modules/expat/libexpat.a',
    'LIBEXPAT_CFLAGS': '-I../Modules/expat -fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -I/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/include -Wno-int-conversion -O2 -I/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/include/ncursesw -I/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/include -Wno-int-conversion -O2 -I/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/include/ncursesw -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I../Include/internal -I../Include/internal/mimalloc -IObjects -IInclude -IPython -I. -I../Include -fPIC -fPIC',
    'LIBEXPAT_HEADERS': '\\',
    'LIBEXPAT_OBJS': '\\',
    'LIBHACL_CFLAGS': '-I../Modules/_hacl/include -D_BSD_SOURCE -D_DEFAULT_SOURCE -fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -I/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/include -Wno-int-conversion -O2 -I/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/include/ncursesw -I/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/include -Wno-int-conversion -O2 -I/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/include/ncursesw -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I../Include/internal -I../Include/internal/mimalloc -IObjects -IInclude -IPython -I. -I../Include -fPIC -fPIC',
    'LIBHACL_HEADERS': '\\',
    ...
    'LIBMPDEC_CFLAGS': '-I../Modules/_decimal/libmpdec -DCONFIG_64=1 -DANSI=1 -DHAVE_UINT128_T=1 -fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -I/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/include -Wno-int-conversion -O2 -I/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/include/ncursesw -I/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/include -Wno-int-conversion -O2 -I/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/include/ncursesw -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I../Include/internal -I../Include/internal/mimalloc -IObjects -IInclude -IPython -I. -I../Include -fPIC -fPIC',
    'LIBMPDEC_HEADERS': '\\',
    'LIBMPDEC_OBJS': '\\',
    'LIBOBJDIR': 'Python/',
    'LIBOBJS': '',
    'LIBPC': '/data/app/base.org/base_1.0/lib/pkgconfig',
    'LIBPL': '/data/app/base.org/base_1.0/lib/python3.13/config-3.13',
    ...
    'LIBS': '-ldl  -lpthread',
    'LIBSUBDIRS': 'asyncio \\',
    'LINKCC': '/home/wyqsxsxz/ohos-sdk/sdk/default/openharmony/native/llvm/bin/x86_64-unknown-linux-ohos-clang',
    ...
    'MULTIARCH': 'x86_64-linux-ohos',
    'MULTIARCH_CPPFLAGS': '-DMULTIARCH=\\"x86_64-linux-ohos\\"',
    ...
    'PYTHONPATH': '',
    'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/home/wyqsxsxz/Termony/build-hnp/python/temp/Python-3.13.5/build _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=../Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_x86_64-linux-ohos _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /home/wyqsxsxz/Termony/build-hnp/python/temp/Python-3.13.5/build/`cat pybuilddir.txt`) /home/wyqsxsxz/Termony/build-hnp/python/temp/native/usr/local/bin/python3',
    'PYTHON_FOR_BUILD_DEPS': '',
    'PYTHON_FOR_FREEZE': '/home/wyqsxsxz/Termony/build-hnp/python/temp/native/usr/local/bin/python3',
    'PYTHON_FOR_REGEN': '',
    'PYTHON_HEADERS': '\\',
    'PYTHON_OBJS': '\\',
    'PY_BUILTIN_HASHLIB_HASHES': '"md5,sha1,sha2,sha3,blake2"',
    'PY_BUILTIN_MODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -I/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/include -Wno-int-conversion -O2 -I/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/include/ncursesw -I/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/include -Wno-int-conversion -O2 -I/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/include/ncursesw -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I../Include/internal -I../Include/internal/mimalloc -IObjects -IInclude -IPython -I. -I../Include -fPIC -DPy_BUILD_CORE_BUILTIN',
    'PY_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -I/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/include -Wno-int-conversion -O2 -I/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/include/ncursesw -I/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/include -Wno-int-conversion -O2 -I/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/include/ncursesw',
    ...
    'PY_CORE_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -I/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/include -Wno-int-conversion -O2 -I/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/include/ncursesw -I/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/include -Wno-int-conversion -O2 -I/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/include/ncursesw -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I../Include/internal -I../Include/internal/mimalloc -IObjects -IInclude -IPython -I. -I../Include -fPIC -DPy_BUILD_CORE',
    'PY_CORE_LDFLAGS': '-L/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/lib -L/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/lib',
    'PY_CPPFLAGS': '-IObjects -IInclude -IPython -I. -I../Include',
    'PY_ENABLE_SHARED': 1,
    'PY_HAVE_PERF_TRAMPOLINE': 0,
    'PY_LDFLAGS': '-L/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/lib -L/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/lib',
    'PY_LDFLAGS_NODIST': '',
    'PY_LDFLAGS_NOLTO': '-L/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/lib -L/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/lib',
    'PY_SQLITE_ENABLE_LOAD_EXTENSION': 0,
    'PY_SQLITE_HAVE_SERIALIZE': 0,
    'PY_SSL_DEFAULT_CIPHERS': 1,
    'PY_SSL_DEFAULT_CIPHER_STRING': 0,
    'PY_STDMODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -I/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/include -Wno-int-conversion -O2 -I/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/include/ncursesw -I/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/include -Wno-int-conversion -O2 -I/home/wyqsxsxz/Termony/build-hnp/python/../sysroot/include/ncursesw -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I../Include/internal -I../Include/internal/mimalloc -IObjects -IInclude -IPython -I. -I../Include -fPIC',
    'PY_SUPPORT_TIER': 0,
    'Py_DEBUG': 0,
    'Py_ENABLE_SHARED': 1,
    'Py_GIL_DISABLED': 0,
    ...
    'RETSIGTYPE': 'void',
    'RUNSHARED': '',
    'SCRIPTDIR': '/data/app/base.org/base_1.0/lib',
    'SCRIPT_IDLE': 'build/scripts-3.13/idle3.13',
    'SCRIPT_PYDOC': 'build/scripts-3.13/pydoc3.13',
    'SETPGRP_HAVE_ARG': 0,
    'SHAREDMODS': 'Modules/array.cpython-313.so Modules/_asyncio.cpython-313.so Modules/_bisect.cpython-313.so Modules/_contextvars.cpython-313.so Modules/_csv.cpython-313.so Modules/_heapq.cpython-313.so Modules/_json.cpython-313.so Modules/_lsprof.cpython-313.so Modules/_opcode.cpython-313.so Modules/_pickle.cpython-313.so Modules/_queue.cpython-313.so Modules/_random.cpython-313.so Modules/_struct.cpython-313.so Modules/_interpreters.cpython-313.so Modules/_interpchannels.cpython-313.so Modules/_interpqueues.cpython-313.so Modules/_zoneinfo.cpython-313.so Modules/math.cpython-313.so Modules/cmath.cpython-313.so Modules/_statistics.cpython-313.so Modules/_datetime.cpython-313.so Modules/_decimal.cpython-313.so Modules/binascii.cpython-313.so Modules/zlib.cpython-313.so Modules/_md5.cpython-313.so Modules/_sha1.cpython-313.so Modules/_sha2.cpython-313.so Modules/_sha3.cpython-313.so Modules/_blake2.cpython-313.so Modules/pyexpat.cpython-313.so Modules/_elementtree.cpython-313.so Modules/_codecs_cn.cpython-313.so Modules/_codecs_hk.cpython-313.so Modules/_codecs_iso2022.cpython-313.so Modules/_codecs_jp.cpython-313.so Modules/_codecs_kr.cpython-313.so Modules/_codecs_tw.cpython-313.so Modules/_multibytecodec.cpython-313.so Modules/unicodedata.cpython-313.so Modules/fcntl.cpython-313.so Modules/grp.cpython-313.so Modules/mmap.cpython-313.so Modules/_posixsubprocess.cpython-313.so Modules/resource.cpython-313.so Modules/select.cpython-313.so Modules/_socket.cpython-313.so Modules/syslog.cpython-313.so Modules/termios.cpython-313.so Modules/_posixshmem.cpython-313.so Modules/_multiprocessing.cpython-313.so',
    'SHELL': '/bin/sh -e',
    'SHLIBS': '-ldl  -lpthread',
    'SHLIB_SUFFIX': '.so',
    ...
    'TESTOPTS': '',
    'TESTPATH': '',
    'TESTPYTHON': '_PYTHON_PROJECT_BASE=/home/wyqsxsxz/Termony/build-hnp/python/temp/Python-3.13.5/build _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=../Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_x86_64-linux-ohos _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /home/wyqsxsxz/Termony/build-hnp/python/temp/Python-3.13.5/build/`cat pybuilddir.txt`) /home/wyqsxsxz/Termony/build-hnp/python/temp/native/usr/local/bin/python3',
    'TESTPYTHONOPTS': '',
    'TESTRUNNER': '_PYTHON_PROJECT_BASE=/home/wyqsxsxz/Termony/build-hnp/python/temp/Python-3.13.5/build _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=../Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_x86_64-linux-ohos _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /home/wyqsxsxz/Termony/build-hnp/python/temp/Python-3.13.5/build/`cat pybuilddir.txt`) /home/wyqsxsxz/Termony/build-hnp/python/temp/native/usr/local/bin/python3 -m test',
    ...
    'VERSION': '3.13',
    'VPATH': '..',
    'WASM_ASSETS_DIR': './data/app/base.org/base_1.0',
    'WASM_STDLIB': './data/app/base.org/base_1.0/lib/python3.13/os.py',
    'WHEEL_PKG_DIR': '',
    'WINDOW_HAS_FLAGS': 0,
    ...
    'abs_builddir': '/home/wyqsxsxz/Termony/build-hnp/python/temp/Python-3.13.5/build',
    'abs_srcdir': '/home/wyqsxsxz/Termony/build-hnp/python/temp/Python-3.13.5/build/..',
    'datarootdir': '/data/app/base.org/base_1.0/share',
    'exec_prefix': '/data/app/base.org/base_1.0',
